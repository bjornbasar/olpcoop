...
class Shanty_Mongo_Connection extends Mongo
{
	...
	protected static $_availableOptions = array('persist', 'timeout', 'replicaSet');
	...
	/**
	 * Get the actual connection string used for this connection.
	 * This differs from __toString in
	...
	public static function parseConnectionString ($connectionString)
	{
		...
		$connectionInfo = array('connectionString' => $connectionString);
